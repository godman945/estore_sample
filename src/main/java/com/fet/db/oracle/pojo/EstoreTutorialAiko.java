...
// Generated 2021/2/5 �U�� 05:27:17 by Hibernate Tools 4.3.5.Final
...
public class EstoreTutorialAiko implements java.io.Serializable {
	...
	public EstoreTutorialAiko(String userName) {
		this.userName = userName;
	}

	public EstoreTutorialAiko(String userName, String id, Long userRemain, String userAddr, Date createTime,
			Date updateTime) {
		this.userName = userName;
		this.id = id;
